...
| --- | ---: | ---: | --- | ---: | ---: |
| `probe-ratio-20260608-155933-probe-ratio` | 0.002177 | 0.1000 | PASS | 257258 | 9 |

## Absolute SLO

| Run | Max Slow Score | Score Pass | State Pass | States |
| --- | ---: | --- | --- | --- |
| `absolute-slo-disabled-20260608-161300-absolute-slo-without_absolute_slo` | 0.377401 | FAIL | FAIL | HEALTHY |
| `absolute-slo-enabled-20260608-161634-absolute-slo-with_absolute_slo` | 1.007183 | PASS | PASS | DEGRADED, HEALTHY |
